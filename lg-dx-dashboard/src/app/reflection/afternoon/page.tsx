...
export default function AfternoonReflectionPage() {
  ...
  const { reflection: existingReflection, isLoading: isFetching } = useReflectionByDateAndTimePart(selectedDate, 'afternoon');
  ...
  const navigateToDate = (newDate: string) => {
    ...
    router.push(`/reflection/afternoon?${params.toString()}`);
  };
