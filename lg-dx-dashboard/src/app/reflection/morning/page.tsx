...
export default function MorningReflectionPage() {
  ...
  const { reflection: existingReflection, isLoading: isFetching } = useReflectionByDateAndTimePart(selectedDate, 'morning');
  ...
  const onSubmit = async (data: ReflectionFormInput) => {
    ...
    if (result.success) {
      toast.success(existingReflection ? '오전 리플렉션이 수정되었습니다!' : '오전 리플렉션이 저장되었습니다!');
  ...
  const navigateToDate = (newDate: string) => {
    ...
    router.push(`/reflection/morning?${params.toString()}`);
  };
    ...
    <div key={selectedDate} className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="text-center space-y-4 mb-8">
        ...
        <p className="text-muted-foreground">
          {isViewMode ? '오전 수업 리플렉션을 확인합니다' : '오전 수업을 마치고 오늘의 학습을 되돌아보세요'}
        </p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                오전 수업에 대한 이해도, 집중도, 성취도를 1-10점으로 평가해주세요
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                오전 수업에서 어려웠던 점이나 개선이 필요한 부분을 기록해보세요
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
          ...
          <Card>
            <CardHeader>
              <CardTitle>📝 오후 목표</CardTitle>
              <CardDescription>
                오후 수업에서 달성하고 싶은 목표를 설정해보세요
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
